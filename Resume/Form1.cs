...
namespace Resume
{
    public partial class Form1 : Form
    {
        ...
        private void highSchoolTitleLabel_Click(object sender, EventArgs e)
        {
        ...
        private void clgName_Click(object sender, EventArgs e)
        {

        }

        private void llnLabel_Click(object sender, EventArgs e)
        {

        }

        private void workExperience_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
